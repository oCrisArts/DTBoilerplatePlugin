import svgPaths from "./svg-hj2e820y6j";
...
function Header() {
  return (
    <div className="bg-[#f7f7f8] relative rounded-tl-[16px] rounded-tr-[16px] shrink-0 w-full" data-name="header">
...
function Container3() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-[500px] relative w-full" data-name="Container">
