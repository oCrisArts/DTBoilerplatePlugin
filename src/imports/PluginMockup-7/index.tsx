import svgPaths from "./svg-7o6irzl4jm";
...
function Text12() {
  return (
    <div className="flex-[224_0_0] h-[15px] min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <p className="[word-break:break-word] absolute font-['Consolas:Regular',sans-serif] leading-[15px] left-0 not-italic text-[#0c0c0d] text-[10px] top-[-1px] whitespace-nowrap">font-family-sans</p>
      </div>
    </div>
  );
}
...
function Text14() {
  return (
    <div className="flex-[224_0_0] h-[15px] min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <p className="[word-break:break-word] absolute font-['Consolas:Regular',sans-serif] leading-[15px] left-0 not-italic text-[#0c0c0d] text-[10px] top-[-1px] whitespace-nowrap">font-family-icon</p>
      </div>
    </div>
  );
}
...
function Container9() {
  return (
    <div className="h-[88px] max-h-[168px] relative shrink-0 w-full" data-name="Container">
