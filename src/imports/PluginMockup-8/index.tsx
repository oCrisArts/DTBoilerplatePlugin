import svgPaths from "./svg-j7vu9gf1wa";
  ...
  return (
    <div className="relative shrink-0 size-[9px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9 9">
        <g clipPath="url(#clip0_2002_1411)" id="Icon">
...
function Text3() {
  return (
    <div className="h-[15px] relative shrink-0 w-[30.781px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 [word-break:break-word] absolute font-['DM_Sans:Medium',sans-serif] font-medium leading-[15px] left-[15.5px] text-[#6e6e80] text-[10px] text-center top-0 whitespace-nowrap" style={{ fontVariationSettings: '"opsz" 14' }}>
          Colors
        </p>
      </div>
    </div>
...
function Button() {
  return (
    <div className="flex-[99.328_0_0] h-[51px] min-w-px relative" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center pb-[14px] pt-[8px] relative size-full">
        <Text2 />
        <Text3 />
      </div>
    </div>
...
function Text5() {
  return (
    <div className="h-[15px] relative shrink-0 w-[56.344px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="-translate-x-1/2 [word-break:break-word] absolute font-['DM_Sans:Medium',sans-serif] font-medium leading-[15px] left-[28.5px] text-[#5e6ad2] text-[10px] text-center top-0 whitespace-nowrap" style={{ fontVariationSettings: '"opsz" 14' }}>
          Typography
        </p>
      </div>
    </div>
  ...
  return (
    <div className="relative shrink-0 size-[10px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10 10">
        <g clipPath="url(#clip0_2002_1407)" id="Icon">
...
function TextInput() {
  return (
    <div className="flex-[236_0_0] h-[15px] min-w-px relative" data-name="Text Input">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start justify-center overflow-clip relative rounded-[inherit] size-full">
        <p className="[word-break:break-word] font-['DM_Sans:9pt_Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[10px] text-[rgba(110,110,128,0.5)] w-full" style={{ fontVariationSettings: '"opsz" 9' }}>
          Search tokens…
        </p>
      </div>
    </div>
...
function Text9() {
  return (
    <div className="flex-[231_0_0] h-[15px] min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
...
function Button3() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Button">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center px-[12px] py-[10px] relative size-full">
          <Text8 />
          <Text9 />
          <Text10 />
        </div>
...
function Text11() {
  return (
    <div className="relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center relative size-full">
        <p className="[word-break:break-word] font-['Material_Symbols_Outlined:Regular',sans-serif] font-normal leading-[10px] relative shrink-0 text-[#0c0c0d] text-[10px] whitespace-nowrap" style={{ fontVariationSettings: '"FILL" 0, "GRAD" 0' }}>
          smartphone
        </p>
      </div>
    </div>
...
function Text12() {
  return (
    <div className="h-[15px] relative shrink-0 w-[209px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <p className="[word-break:break-word] absolute font-['Consolas:Regular',sans-serif] leading-[15px] left-0 not-italic text-[#0c0c0d] text-[10px] top-[-1px] whitespace-nowrap">columns-mobile</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[40px] min-h-[40px] relative rounded-[6px] shrink-0 w-full" data-name="Container">
      <div className="flex flex-row items-center min-h-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[10px] items-center min-h-[inherit] px-[8px] relative size-full">
          <Container11 />
          <Text12 />
        </div>
      </div>
...
function Text14() {
  return (
    <div className="flex-[209_0_0] h-[15px] min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <p className="[word-break:break-word] absolute font-['Consolas:Regular',sans-serif] leading-[15px] left-0 not-italic text-[#0c0c0d] text-[10px] top-[-1px] whitespace-nowrap">columns-tablet</p>
      </div>
    </div>
  );
}
...
function Text16() {
  return (
    <div className="h-[15px] relative shrink-0 w-[209px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <p className="[word-break:break-word] absolute font-['Consolas:Regular',sans-serif] leading-[15px] left-0 not-italic text-[#0c0c0d] text-[10px] top-[-1px] whitespace-nowrap">columns-desktop</p>
      </div>
    </div>
  );
}
...
function Text18() {
  return (
    <div className="flex-[209_0_0] h-[15px] min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <p className="[word-break:break-word] absolute font-['Consolas:Regular',sans-serif] leading-[15px] left-0 not-italic text-[#0c0c0d] text-[10px] top-[-1px] whitespace-nowrap">gutters</p>
      </div>
    </div>
  );
}
...
function Text20() {
  return (
    <div className="flex-[209_0_0] h-[15px] min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <p className="[word-break:break-word] absolute font-['Consolas:Regular',sans-serif] leading-[15px] left-0 not-italic text-[#0c0c0d] text-[10px] top-[-1px] whitespace-nowrap">padding</p>
      </div>
    </div>
  );
}
...
function Text22() {
  return (
    <div className="flex-[209_0_0] h-[15px] min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
        <p className="[word-break:break-word] absolute font-['Consolas:Regular',sans-serif] leading-[15px] left-0 not-italic text-[#0c0c0d] text-[10px] top-[-1px] whitespace-nowrap">margin</p>
      </div>
    </div>
  );
}
...
function Text24() {
  return (
    <div className="flex-[231_0_0] h-[15px] min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="[word-break:break-word] absolute font-['DM_Sans:Medium',sans-serif] font-medium leading-[15px] left-0 text-[#6e6e80] text-[10px] top-0 whitespace-nowrap" style={{ fontVariationSettings: '"opsz" 14' }}>
          Radius
        </p>
      </div>
    </div>
...
function Container5() {
  return (
    <div className="bg-white min-h-[500px] relative shrink-0 w-full" data-name="Container">
  ...
  return (
    <div className="relative shrink-0 size-[11px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11 11">
        <g clipPath="url(#clip0_2002_1404)" id="Icon">
...
function Button6() {
  return (
    <div className="bg-[#0c0c0d] h-[40px] relative rounded-[8px] shrink-0 w-full" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[6px] items-center justify-center relative size-full">
        <Icon2 />
        <Text31 />
      </div>
